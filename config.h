...
static const char *vim[] = { "st", "-f", "FiraCode Nerd Font:size=12:style=Bold" , "-e" , "nvim", NULL };
...
static const char *pipeviewer[] = { "st", "-f", "FiraCode Nerd Font:size=16:style=bold:antialias=true:autohint=true", "-e", "pipe-viewer", NULL };
